...
public class GeneratorServiceTest {
    ...
    public void testGeneratorService_notNullJacksonAnnotation_True() throws IOException {
    ...
    @Test(description = "test generator service with spring")
    public void testGeneratorService_notNullJacksonAnnotation_False() throws IOException {
